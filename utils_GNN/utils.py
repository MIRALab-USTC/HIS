...
from utils_GNN.const import LABEL_DICT
...
class GraphDataset(torch_geometric.data.Dataset):
    ...
    def get(self, index):
        ...
        graph = BipartiteNodeData(pivot_node_features, edge_indices, children_node_features, label)
        graph.num_nodes = pivot_node_features.shape[0]+children_node_features.shape[0]
        return graph
